...
class ChooseDoctorByProfession: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.async {
            ...
            self.doctorsData = DataLoader(urlMethod: "&method=getUsers", urlParameter: urlParameter).doctorsData
...
extension ChooseDoctorByProfession: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let vc = DateRecordChoiceController(id: doctorsData[indexPath.row].id)
